...
import { registerForPushNotification } from '../../Services/Notification/RegisterForPushNotification'
export default class RegisterScreen extends React.Component {
    ...
    componentDidMount() {
      ...
      const TOKEN = registerForPushNotification()
      console.log('munneeebb '+TOKEN)
    }
